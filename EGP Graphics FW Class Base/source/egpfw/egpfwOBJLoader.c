...
int egpfwSaveBinaryOBJ(const egpTriOBJDescriptor *obj, const char *binPath)
{
	...
	for (int i = 0; i < obj->numFaces; i++)
	{
		...
		//--obj->faces[i].vertexIndicies[0]; --obj->faces[i].texcoordIndicies[0]; --obj->faces[i].normalIndicies[0];
		//--obj->faces[i].vertexIndicies[1]; --obj->faces[i].texcoordIndicies[1]; --obj->faces[i].normalIndicies[1];
		//--obj->faces[i].vertexIndicies[2]; --obj->faces[i].texcoordIndicies[2]; --obj->faces[i].normalIndicies[2];
	}
